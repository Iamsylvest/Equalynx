  ...
  <div class="relative flex h-screen">
    ...
    <div
      :class="[
        ...
        'fixed top-0 left-0 h-full w-64 bg-white transform transition-transform duration-300 ease-in-out z-40'
      ]"
    >
      <!-- LOGO -->
      ...
      <div class="mb-10">
        ...
        <div>
          <button
          @click="toggleSidebar"
          class="bg-custom-blue text-white px-4 py-2 rounded flex items-center justify-center m-auto relative top-12"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
    ...
    <div class="flex flex-col items-center justify-center ">
      ...
      <header class="p-2 bg-white shadow h-screen ">
