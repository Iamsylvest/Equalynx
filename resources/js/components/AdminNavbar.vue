<template>
    <div class="relative flex h-screen">
      <!-- Sidebar -->
      <div 
        v-bind:style="{ width: isSidebarWide ? '250px' : '100px' }"
      ...
      <div class="relative top-[-100px]">
            ...
            <router-link to="/" class="flex items-center mx-6 mb-2 text-xs p-4 text-black-200 uppercase tracking-widest cursor-pointer hover:text-white-600 hover:bg-custom-blue rounded-full hover:text-white focus:outline-none">
                <svg
            ...
            <router-link to="/Inventory" class="flex items-center mx-6 mb-2 text-xs p-4 text-black-200 uppercase tracking-widest cursor-pointer hover:text-white-600 hover:bg-custom-blue rounded-full hover:text-white  focus:outline-none">
                <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    fill="none" 
                    viewBox="0 0 24 24" 
